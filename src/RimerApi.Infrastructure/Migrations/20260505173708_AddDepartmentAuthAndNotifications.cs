...
{
    /// <inheritdoc />
    public partial class AddDepartmentAuthAndNotifications : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransferredById = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketTransfers_Departments_FromDepartmentId",
                        column: x => x.FromDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketTransfers_Departments_ToDepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_LastTransferredAt",
                table: "Tickets",
                column: "LastTransferredAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketTransfers_FromDepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketTransfers_ToDepartmentId",
                table: "TicketTransfers",
